package com.weatherforecast.constants;
...
public class WeatherForecastConstants {
    ...
    private WeatherForecastConstants(){
    ...
    public static final String GENERIC_EXCEPTION_OCCURED = "Open Weather client returned the above error message for the given input!!!";
